const TestimonialCard = ({ testimonial }) => {
  return (
    <div className="col-span-1 bg-black-300 testimonial-card group 
    rounded-xl ">
      ...
      <div className="flex items-center justify-between">
        <img
          ...
          alt="cover-img"
          className="md:w-36 md:h-36 w-24 h-24 border border-transparent rounded-full
          group-hover:border-white group-hover:translate-y-2 group-hover:translate-x-2 transition-all duration-700"
        />
        <img
      ...
      <div className="flex md:flex-row flex-col md:items-center justify-between md:mt-20 mt-10">
        ...
        <div className="flex items-center gap-3 md:mt-0 mt-5">
          <i class='bx bxl-whatsapp md:text-5xl text-2xl  group-hover:text-white-50 transition-all duration-700'></i>
          <i class='bx bxl-instagram md:text-5xl text-2xl  group-hover:text-white-50 transition-all duration-700'></i>
        </div>
      </div>
      </div>
    </div>
